...
const ListProduct = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      setError(null);
      try {
        const data = await placementApi.getPhones();
        setProducts(data);
      } catch (err) {
  ...
  const phoneCategories = [
    ...
    },
    {
      ...
      title: "Điện thoại pin trâu",
      to: "/phones?special=battery",
    },
    {
      img: "https://cdn2.cellphones.com.vn/insecure/rs:fill:96:96/q:90/plain/https://cellphones.com.vn/media/wysiwyg/Web/icon/mobile-chup-anh.png",
      title: "Điện thoại chụp đẹp",
      to: "/phones?special=camera",
    },
    {
      ...
      title: "Điện thoại gập đẹp",
      to: "/phones?special=foldable",
    },
  ];

  const brandLinks = [
    { label: "Tất cả", to: "/phones" },
    { label: "Apple", to: "/Apple" },
    { label: "Samsung", to: "/Samsung" },
    { label: "OPPO", to: "/Oppo" },
    { label: "Xiaomi", to: "/Xiaomi" },
    { label: "Realme", to: "/Realme" },
    { label: "OnePlus", to: "/Oneplus" },
    { label: "Sony", to: "/Sony" },
  ];

  /* Active brand: match full path + search */
  const currentFullPath = location.pathname + location.search;
  const isActive = (to) => currentFullPath === to;
      ...
      <div className="max-w-[1200px] mx-auto px-2 sm:px-3 pt-[72px] sm:pt-[88px] pb-8 sm:pb-10">
        <div className="flex gap-3 lg:gap-4 items-start">
          ...
          <aside className="hidden lg:flex flex-col gap-3 w-[200px] min-w-[200px] sticky top-[90px] self-start pt-2">
            {[
              "https://cdn2.cellphones.com.vn/insecure/rs:fill:214:530/q:90/plain/https://media-asset.cellphones.com.vn/page_configs/01K9FHDET12SD99YHQGPHR60XA.png",
              "https://cdn2.cellphones.com.vn/insecure/rs:fill:214:530/q:90/plain/https://media-asset.cellphones.com.vn/page_configs/01K9E4D31SP0912AG9GG6PHREG.png",
            ].map((src, i) => (
              <div
                key={i}
