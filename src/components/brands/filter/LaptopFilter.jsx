...
/* ─── BRAND LOGOS (inline SVG/text — không phụ thuộc external URL) ── */
const BrandLogo = ({ brand, active }) => {
  ...
  const logos = {
    ...
    Dell: (
      <span style={{ fontSize:13, fontWeight:900, color:c, letterSpacing:0.5 }}>DELL</span>
    ),
    HP: (
      <span style={{ fontSize:16, fontWeight:900, color:c, letterSpacing:-1 }}>hp</span>
    ),
    Asus: (
      <span style={{ fontSize:11, fontWeight:900, color:c, letterSpacing:1 }}>ASUS</span>
    ),
    Lenovo: (
      <span style={{ fontSize:10, fontWeight:900, color:c, letterSpacing:0.5 }}>Lenovo</span>
    ),
    Acer: (
      <span style={{ fontSize:11, fontWeight:900, color:c, letterSpacing:0.5 }}>Acer</span>
    ),
  };
  ...
  return (
    <>
      <style>{`
        ...
        .pfw-brand img   { max-width:100%; max-height:20px; object-fit:contain; transition:filter .2s; }
        .pfw-brand:not(.on) img { filter:grayscale(20%) opacity(.72); }
        .pfw-btick {
        ...
        .pfw-dlbl { flex:1; text-align:left; font-size:11px; font-weight:600; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        .pfw-dcnt {
        ...
        @media (max-width:900px) {
          ...
          .pfw-brands { grid-template-columns:repeat(4,1fr); }
        }
        ...
        <div className="pfw-wrap">
          ...
          <div className="pfw-header">
            <div className="pfw-hleft">
              ...
              <div>
                <div className="pfw-htitle">Bộ lọc Laptop</div>
                <div className="pfw-hsub">Tìm đúng chiếc laptop </div>
              </div>
            </div>
          ...
          {/* BRAND */}
          <div className="pfw-slabel"><span className="pfw-sbar"/><span>Hãng Laptop</span></div>
